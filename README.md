...
## Release Notes
### 1.7.0
- added new command "Rebuild Index" for manually full rebuild by user choice
- added file processing indication for user to see the processing of file amount

### 1.6.0
- add keybind for extension focus and to search text box focus
- add save state for file list/tree view after loosing focus and when returning to the visual studio code enviroment
- added user option to set the default view to either file tree view or file list

### 1.5.9
- added context menu to open file/folder in file explorer

### 1.5.8
- The extension now automatically sets "workbench.view.alwaysShowHeaderActions" to true when it activates. This will make all view toolbar buttons (including FILES window buttons) always visible regardless of mouse position or focus. Reload the extension to apply the change.
if you don't like it you can switch it off in user settings.
...
### 1.5.0
- Fixed search 
- Make search faster via indexing
- Some UI improments
