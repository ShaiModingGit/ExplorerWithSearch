...
export class SearchViewProvider implements vscode.WebviewViewProvider {
    ...
    public setStatus(status: 'indexing' | 'ready', progress?: { processed: number; total: number }) {
        if (this._view) {
    ...
    public async focusSearchInput() {
        // First, reveal and show the view
        if (this._view) {
        ...
        window.addEventListener('message', event => {
            ...
            if (message.type === 'restore') {
                ...
                if (message.status === 'indexing') {
                    ...
                    showStatus('Indexing workspace... (' + processed + '/' + total + ')');
